...
void run() {
  ...
  while (true) {
    ...
    if (cmdBot.contains('help')) {
      ...
      print("=================");
      print(
          """uci : Demander au moteur d'utiliser l'uci (interface universelle d'échecs,
      ...
      print(
          """isready : Ceci est utilisé pour synchroniser le moteur avec l'interface graphique. Lorsque l'interface graphique a envoyé une commande ou
      ...
      print(
          """ucinewgame : Ceci est envoyé au moteur lorsque la prochaine recherche (démarrée par "position" et "go") aura lieu à partir d'
